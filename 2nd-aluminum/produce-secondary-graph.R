...
second_aluminum_ggi <- data.frame(Source = c(rep("Primary", 5), rep("Scrap", 5), rep("Primary", 5), rep("Scrap", 5)), 
                                  Scrap_Amount = rep(rep(c("0%", "25%", "50%", "75%", "100%"), times = c(1, 1, 1, 1, 1)), 4),
                                  Scrap_Amount_num = rep(rep(c(0, 0.25, .50, .75, 1), times = c(1, 1, 1, 1, 1)), 4), 
...
second_aluminum_ggi_cus <- data.frame(Source = c(rep("Primary", 5), rep("Scrap", 5)),
                                      Scrap_Amount = rep(rep(c("0%", "25%", "50%", "75%", "100%"), times = c(1, 1, 1, 1, 1)), 2),
                                      Scrap_Amount_num = rep(rep(c(0, 0.25, .50, .75, 1), times = c(1, 1, 1, 1, 1)), 2),
